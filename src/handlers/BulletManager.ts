class BulletManager {
  ...
  constructor(private scene: Phaser.Scene, private texture: string, maxSize: number, cd?: number, collisionbox?: { x: number, y: number, width: number, height: number }, private onFire?: (context: any) => void, private context?: any) {
